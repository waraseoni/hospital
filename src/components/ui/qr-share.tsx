      ...
      <Modal open={open} onOpenChange={() => setOpen(false)} title="Share via QR Code">
        <div className="flex flex-col items-center gap-4 py-2">
          {qrDataUrl ? (
            ...
            <div className="flex h-[232px] w-[232px] items-center justify-center rounded-xl border bg-muted/30">
          ...
          <div className="w-full rounded-lg bg-muted/40 px-3 py-2 text-center">
            <p className="text-[10px] text-muted-foreground mb-1">Scan to open this page</p>
            <p className="text-xs font-medium truncate text-foreground">{shareUrl}</p>
          </div>
